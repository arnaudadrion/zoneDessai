...
use App\Entity\Survey\Question\OrderQuestion;
 ...
 */
class OrderQuestionRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, OrderQuestion::class);
    }
}
